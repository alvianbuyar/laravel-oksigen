            ...
            <div class="row">
              <div class="col-sm-6 col-lg-5">
                <div class="input-group" style="margin-top: 5mm">
                  <input type="text" class="form-control" placeholder="Search Something?" style="padding: 7mm 6mm 7mm 4mm; font-size:4mm">
                  <div class="input-group-append">
                  <span class="input-group-text">
                    <div class="text-center">
                      <a href="#" class="btn btn-primary" role="button" style="margin: -2mm; padding: 3mm 6mm 3mm 6mm">
                        Search
